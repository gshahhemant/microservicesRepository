...
public class SwaggerConfig {
	...
	public Docket productApi() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				...
				.paths(PathSelectors.regex("/services/v2.*")) // all controller will be display in case if you have many
	...
	private ApiInfo metaData() {
		ApiInfo apiInfo = new ApiInfo("Spring Boot REST API", "Spring Boot REST API for Online Store", "1.0",
				"Terms of service",
				new Contact("Hemant Shah", "hshah@intersysconsulting.com", "gshah.hemant@gmail.com"),
